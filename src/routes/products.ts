    ...
    try {
        ...
        if(Object.keys(req.query).length) {
            ...
            if(req.query.price) {
                ...
                if(!data) {
                    next(ApiError.badRequest('Bad request. You need to write the request as ?price=10:50 (to set a price range) or ?price=10 (to get products with the price more than 10) or ?price=:50 (to get products with the price less than 50)'));
                    return;
                }
